...
export const Timeline: React.FC<TimelineProps> = ({ paintings, onSelect }) => {
  ...
  return (
    <div className="w-full bg-white/10 dark:bg-slate-800/20 rounded-3xl p-1 border border-white/30 dark:border-white/5 shadow-[0_8px_32px_rgba(0,0,0,0.05)] backdrop-blur-3xl transition-all duration-500 relative">
      ...
      {/* Scrollable Area */}
      <div className="w-full overflow-x-auto overflow-y-visible pb-6 px-4 scrollbar-thin scrollbar-thumb-blue-500/20 scrollbar-track-transparent">
            ...
            <ResponsiveContainer width="100%" height="100%">
                ...
                <Tooltip
                    ...
                    if (active && payload && payload.length) {
                        ...
                        return (
                        <div className="bg-white/95 dark:bg-slate-900/95 border border-white/40 dark:border-white/10 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.25)] text-sm backdrop-blur-xl min-w-[240px] overflow-hidden pointer-events-none">
