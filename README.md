...
<sub>Originally scaffolded with [Google AI Studio](https://ai.studio/apps/drive/1DxUA9WUT3GoS6haYo39WVqIkjfiCx4kB). Deployed and fixed with [Claude Code](https://claude.ai/claude-code). 100% vibecoded. Images from Wikimedia Commons. Historical data generated by Gemini 2.5 Flash. Educational demonstration only.</sub>
